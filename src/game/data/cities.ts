...
const CITY_TEMPLATES: CityTemplate[] = [
  ...
  // ── Yi province (Sichuan) ──
  {
    ...
    coords: { x: 455, y: 405 },
    adjacentCityIds: ['changan', 'chengdu', 'wancheng', 'xiangyang', 'anding', 'wudu', 'mei', 'yangping', 'shangyong', 'baxi', 'yinping', 'xincheng', 'jiameng'],
    terrain: 'mountain',
  ...
  },
  {
    ...
    coords: { x: 565, y: 500 },
    adjacentCityIds: ['xiangyang', 'changsha', 'jiangling', 'gongan'],
  ...
  },
  {
    ...
    coords: { x: 590, y: 460 },
    adjacentCityIds: ['xiangyang', 'jiangxia', 'wuling', 'yiling', 'maicheng', 'chaisang', 'baqiu', 'xiling', 'gongan'],
    terrain: 'water',
    port: true,
  ...
  },
  {
    ...
    name: { en: 'Baqiu', zh: '巴丘' },
    coords: { x: 620, y: 485 },
    adjacentCityIds: ['jiangling', 'changsha', 'wuling', 'gongan'],
  ...
  // Yi (Shu) commanderies
  {
    ...
    name: { en: 'Baxi', zh: '巴西' },
    coords: { x: 410, y: 425 },
    adjacentCityIds: ['hanzhong', 'chengdu', 'jiangzhou', 'yangping', 'jiameng'],
  ...
  },
  {
    ...
    coords: { x: 385, y: 405 },
    adjacentCityIds: ['hanzhong', 'wudu', 'jiangzhou', 'mianzhu'],
  ...
  // Liang frontier — Wei vs Shu corridor
  {
    ...
    coords: { x: 435, y: 365 },
    adjacentCityIds: ['changan', 'tianshui', 'wuguan', 'yangping', 'jieting'],
    terrain: 'pass',
  ...
  },
  {
    ...
    coords: { x: 390, y: 365 },
    adjacentCityIds: ['changan', 'chencang', 'wudu', 'anding', 'longxi', 'jieting'],
  ...
  // Yi province (Sichuan) attack route — historical 劉備入蜀 / 諸葛瞻決戰 path
  {
    ...
    coords: { x: 425, y: 420 },
    adjacentCityIds: ['hanzhong', 'yangping', 'baxi', 'zitong'],
    terrain: 'mountain',
  ...
  },
  {
    ...
    coords: { x: 405, y: 428 },
    adjacentCityIds: ['jiameng', 'fucheng'],
    terrain: 'mountain',
