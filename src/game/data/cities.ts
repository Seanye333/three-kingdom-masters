...
const CITY_TEMPLATES: CityTemplate[] = [
  ...
  },
  {
    ...
    name: { en: 'Ye', zh: '鄴' },
    coords: { x: 615, y: 280 },
    adjacentCityIds: ['beiping', 'taiyuan', 'luoyang', 'xuchang', 'pengcheng', 'bohai', 'pingyuan', 'shangdang', 'guandu', 'hulao', 'baima', 'yanjin', 'liyang'],
  ...
  // Liang frontier — Wei vs Shu corridor
  {
    ...
    coords: { x: 435, y: 365 },
    adjacentCityIds: ['changan', 'tianshui', 'wuguan', 'yangping', 'jieting', 'sanguan'],
    terrain: 'pass',
