  ...
  return (
    <div style={{
      ...
      <div style={{ flex: 1, fontSize: '0.82rem', lineHeight: 1.5 }}>
        <div style={{ color: '#f0d98a' }}>{t('把遊戲裝到主屏幕,全屏離線玩', 'Install to your home screen — fullscreen, offline')}</div>
        {isIOS ? (
          <div style={{ color: '#a89070', fontSize: '0.74rem' }}>
      ...
      {!isIOS && installEvt && (
        <button
          ...
          style={{
            ...
            color: '#f0d98a', padding: '0.45rem 1rem', cursor: 'pointer',
      ...
      <button
        onClick={dismiss}
        style={{ background: 'transparent', border: 'none', color: '#8a7050', fontSize: '1.1rem', cursor: 'pointer', padding: '0 0.2rem' }}
      >✕</button>
    </div>
  );
}
